...
a.Aa))}b.resolve()});return b.Pb},s_ILh=function(a){if("NONE"===a.Ba||a.Ia||a.Dd){if(3===a.Ka)a.Ka=2;else if(2===a.Ka){a.Ka=1;a.wa.shift();null!==a.$d&&a.wa.push(a.$d);a.$d=a.hU;var b=a.wa[0].x-a.wa[1].x,c=a.wa[0].y-a.wa[1].y;0<b?a.Ba="RIGHT":0>b?a.Ba="LEFT":0<c?a.Ba="DOWN":0>c&&(a.Ba="UP");a.Va=a.Ba}else 1===a.Ka&&(a.Ka=0);a.Ia&&(0<a.zf?a.zf--:a.zf=a.rB);0<a.$f&&--a.$f}else{b=s_b(a.Ea);for(c=b.next();!c.done;c=b.next())c=c.value,c.hG||(c.z0=(c.z0+1)%6),c.hG=!1;b=s_b(a.Xh);for(c=b.next();!c.done;c=
